...
./minic task201case/$1.in > tokens.txt		#执行最终生成的程序
#cat tokens.txt
diff -b tokens.txt /home/ubuntu/miniC/answers/lab2/task201case/answer$1.txt											#显示程序运行结果
fi 