...
#line 1695 "parser.cpp"
  ...
  case 12:
#line 124 "parser.y"
                                             {(yyval.nStructSpecifier)=new NStructSpecifier((yyvsp[-3].nIdentifier),(yyvsp[-1].nDefList));if((yyvsp[-3].nIdentifier))(yyval.nStructSpecifier)->line=(yyvsp[-3].nIdentifier)->line;}
...
#line 1707 "parser.cpp"
  ...
  case 14:
#line 128 "parser.y"
           {(yyval.nIdentifier)=new NIdentifier(1,std::string((yyvsp[0].type_id)));(yyval.nIdentifier)->line=yylineno-1;}
...
#line 1719 "parser.cpp"
  ...
  case 16:
#line 132 "parser.y"
        {(yyval.nIdentifier)=new NIdentifier(2,std::string((yyvsp[0].type_id)));(yyval.nIdentifier)->line=yylineno;}
#line 1725 "parser.cpp"
    break;

  case 17:
#line 136 "parser.y"
            {auto t=new NIdentifier(4,std::string((yyvsp[0].type_id)));(yyval.nVarDec)=new NVarDec(*t);(yyval.nVarDec)->line=yylineno;}
...
#line 1737 "parser.cpp"
  ...
  case 19:
#line 139 "parser.y"
                         {auto t=new NIdentifier(3,std::string((yyvsp[-3].type_id)));(yyval.nFunDec)=new NFunDec(*t,(yyvsp[-1].nVarList));(yyval.nFunDec)->line=yylineno;}
#line 1743 "parser.cpp"
    break;

  case 20:
#line 140 "parser.y"
                   {auto t=new NIdentifier(3,std::string((yyvsp[-2].type_id)));(yyval.nFunDec)=new NFunDec(*t,nullptr);(yyval.nFunDec)->line=yylineno;}
...
#line 1767 "parser.cpp"
  ...
  case 24:
#line 149 "parser.y"
                                 {(yyval.nCompSt)=new NCompSt((yyvsp[-2].nDefList),(yyvsp[-1].nStmtList));if((yyvsp[-2].nDefList))(yyval.nCompSt)->line=(yyvsp[-2].nDefList)->line-1;else if((yyvsp[-1].nStmtList))(yyval.nCompSt)->line=(yyvsp[-1].nStmtList)->line-1;}
...
#line 1935 "parser.cpp"
  ...
  case 52:
#line 192 "parser.y"
                        {(yyval.nExpression)=new NBinaryOperator(*(new std::string("RELOP")),*(yyvsp[-2].nExpression),RELOP,*(yyvsp[0].nExpression));(yyval.nExpression)->line=yylineno;}
...
#line 1989 "parser.cpp"
  ...
  case 61:
#line 203 "parser.y"
                        {auto t=NIdentifier(0,std::string((yyvsp[-3].type_id)));(yyval.nExpression)=new NMethodCall(t,(yyvsp[-1].nArgs));(yyval.nExpression)->line=yylineno;}
#line 1995 "parser.cpp"
    break;

  case 62:
#line 204 "parser.y"
                        {auto t=NIdentifier(0,std::string((yyvsp[-2].type_id)));(yyval.nExpression)=new NMethodCall(t);(yyval.nExpression)->line=yylineno;}
...
#line 2007 "parser.cpp"
  ...
  case 64:
#line 206 "parser.y"
                        {auto t=NIdentifier(0,std::string((yyvsp[0].type_id)));(yyval.nExpression)=new NDotOperator(*(yyvsp[-2].nExpression),t);(yyval.nExpression)->line=yylineno;}
#line 2013 "parser.cpp"
    break;

  case 65:
#line 207 "parser.y"
                        {(yyval.nExpression)=new NIdentifier(0,std::string((yyvsp[0].type_id)));(yyval.nExpression)->line=yylineno;}
